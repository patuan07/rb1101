...
def generate_launch_description():
    ...
    pkg_rb1101_gz = FindPackageShare('rb1101_gz') 
    ...
    path_model = PathJoinSubstitution([
        pkg_rb1101_gz, 'urdf', LaunchConfiguration('model')
    ])
    
    ld.add_action(arg_model)

    # for loading the model
    env_gz = SetEnvironmentVariable("GAZEBO_MODEL_PATH", pkg_rb1101_gz)
    ...
    arg_world = DeclareLaunchArgument(
        ...
        default_value='rb1101_world.sdf', # RB1101 Wall-Following
        # default_value='/home/marmot/Documents/rb1101/src/rb1110_gz/worlds/rb1101_world.sdf',
        description='Name of the Gazebo world file to load'
    )
    path_world = PathJoinSubstitution([
        pkg_rb1101_gz, 'worlds', LaunchConfiguration('world')
    ])
    ...
    # Add args to spawn nanocar robot model at specific xy and yaw heading
    ...
    #     package='rviz2',
    #     executable='rviz2',
    #     arguments=['-d', PathJoinSubstitution([pkg_rb1101_gz, 'rviz', 'rb1101.rviz']),],
    #     output='screen'
    # )
